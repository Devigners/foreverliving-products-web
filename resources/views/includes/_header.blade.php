						...
						<div class="header-brand">
							<a href="{{ route('page-home') }}" class="nav-title">
								<img src="{{ asset('images/logo.png') }}"
									alt="mainmenu-navbar-logo" width="60" height="60" />
							</a>
							<a href=""
								class="logo logo-light">
								<img src="{{ asset('images/logo.png') }}"
									alt="mainmenu-navbar-logo-2" width="60" height="60" />
							</a>
						</div>
					</div>
					...
					<nav class="mainmenu-nav">
						...
						<div class="mobile-nav-brand">
							<a href="{{ route('page-home') }}" class="logo">
								<img src="{{ asset('images/logo.png') }}"
									alt="mobile-mainmenu-navbar-logo" width="60" height="60" />
							</a>
						</div>
						<div class="d-flex w-100 justify-content-between align-items-center mobile-nav-body">
							...
							<div class="profile-details">
								...
								<div class="dummy-profile-image">
									<img src="{{ asset('images/about/about-me.jpg') }}"
										alt="about-me-profile" style="border-radius: 100%" />
								</div>
							</div>

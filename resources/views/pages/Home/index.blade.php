					...
					<div class="about-thumbnail">
						<div class="thumbnail text-center">
							<img style="max-height: 350px; object-fit: cover; object-position: center;margin: 0 auto; width: auto"
								src="{{ asset('images/about/about-01.png') }}"
								alt="About Us" />
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-5 order-lg-2">
					<div class="about-thumbnail">
						<img src="{{ asset('images/about/about-03.jpg') }}"
							alt="about" />
					</div>
				</div>
				...
				<div class="col-lg-5">
					<div class="about-thumbnail">
						<img style="object-fit: cover; object-position: top;"
							src="{{ asset('images/about/about-07.png') }}"
							alt="about" />
					</div>
				</div>
				<div class="col-lg-7">
			...
			<div class="row bg-color-lighter p-5" style="border-radius: 5px">
				...
				<div
					...
					<div class="slick-single-layout testimonial-style-one">
						...
						<div class="media">
							<div class="thumbnail">
								<img src="{{ asset('images/testimonials/image-1.png') }}"
					...
					<div class="slick-single-layout testimonial-style-one">
						...
						<div class="media">
							<div class="thumbnail">
								<img src="{{ asset('images/testimonials/image-2.png') }}"
									alt="testimonial image" />
							</div>
							<div class="media-body">
